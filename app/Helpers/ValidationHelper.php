...
class ValidationHelper
{
    private const LABELS = [
        ...
        'price' => 'Harga Paket',
        'package' => 'Nama Paket',
        'default_airline' => 'Maskapai Default',
        'service_notes' => 'Rincian Layanan',
        'is_active' => 'Status Paket',
        'datetime' => 'Tanggal Keberangkatan',
        'airlines' => 'Maskapai Pergi',
        'airlines_select' => 'Maskapai Pergi',
        'airlines_other' => 'Maskapai Pergi (Lainnya)',
        'returndate' => 'Tanggal Kembali',
        'airlines2' => 'Maskapai Pulang',
        'airlines2_select' => 'Maskapai Pulang',
        'airlines2_other' => 'Maskapai Pulang (Lainnya)',
        'pdf_file' => 'File PDF',
        'status' => 'Status',
