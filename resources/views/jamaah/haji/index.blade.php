...
@section('content')
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exportModalLabel">Export Data Jamaah Haji</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
    ...
    function exportJamaah(travelId) {
        ...
        window.open(`/jamaah/haji/export?travel_id=${travelId}`, '_blank');
    }
    
    // Global export function
    function exportGlobal(format) {
        const url = `/jamaah/haji/export?format=${format}&type=global`;
    ...
    function globalSearch() {
        ...
        accordions.forEach(accordion => {
            const travelName = accordion.getAttribute('data-travel-name');
            const kabupaten = accordion.getAttribute('data-kabupaten');
            const travelNameLower = travelName.includes('ppiu') ? travelName : travelName.replace('kabupaten', 'kota');
            const kabupatenLower = kabupaten.replace('kabupaten', 'kota');

            if (travelNameLower.includes(searchTerm) || kabupatenLower.includes(searchTerm)) {
