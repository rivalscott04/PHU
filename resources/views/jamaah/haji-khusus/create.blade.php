                        ...
                        <div class="col-md-4">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="text" class="form-control @error('kode_pos') is-invalid @enderror" 
                                       id="kode_pos" name="kode_pos" value="{{ old('kode_pos') }}" maxlength="5" required>
                                @error('kode_pos')
                                    <div class="invalid-tooltip">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 position-relative">
                                ...
                                <select class="form-select @error('pergi_haji') is-invalid @enderror" 
                                    ...
                                    <option value="">Pilih Status</option>
                                    <option value="Belum" {{ old('pergi_haji') == 'Belum' ? 'selected' : '' }}>Belum</option>
                                    <option value="Sudah" {{ old('pergi_haji') == 'Sudah' ? 'selected' : '' }}>Sudah</option>
                                </select>
                                @error('pergi_haji')
                                    <div class="invalid-tooltip">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="date" class="form-control @error('tanggal_berlaku_paspor') is-invalid @enderror" 
                                       id="tanggal_berlaku_paspor" name="tanggal_berlaku_paspor" value="{{ old('tanggal_berlaku_paspor') }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="text" class="form-control @error('tempat_terbit_paspor') is-invalid @enderror" 
                                       id="tempat_terbit_paspor" name="tempat_terbit_paspor" value="{{ old('tempat_terbit_paspor') }}">
                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <input type="text" class="form-control @error('nomor_porsi') is-invalid @enderror"
                                    id="nomor_porsi" name="nomor_porsi" value="{{ old('nomor_porsi') }}" maxlength="20"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="date" class="form-control @error('tahun_pendaftaran') is-invalid @enderror" 
                                       id="tahun_pendaftaran" name="tahun_pendaftaran" value="{{ old('tahun_pendaftaran') }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="file" class="form-control @error('bukti_setor_bank') is-invalid @enderror" 
                                       id="bukti_setor_bank" name="bukti_setor_bank" accept=".pdf,.jpg,.jpeg,.png" required>
                                <small class="text-muted">Format: PDF, JPG, JPEG, PNG (Max: 2MB)</small>
