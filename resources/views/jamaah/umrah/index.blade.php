                    ...
                    @if (auth()->user()->role === 'admin' && $groupedJamaah)
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0" id="globalSearch"
                                            placeholder="Cari PPIU atau nama jamaah..." onkeyup="globalSearch()">
                                    </div>
                                </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    <small class="text-muted">
                                        ...
                                        <strong>{{ $groupedJamaah->sum(function ($group) {return $group->count();}) }}</strong>
                                        Jamaah
                                    </small>
                                </div>
                                <div class="col-md-6 text-end">
                        ...
                        <div class="accordion" id="travelAccordion">
                            @foreach ($groupedJamaah as $travelId => $jamaahGroup)
                                ...
                                <div class="accordion-item border-0 mb-3 shadow-sm travel-item"
                                    data-travel-name="{{ strtolower($travel->Penyelenggara ?? '') }}"
                                    data-kabupaten="{{ strtolower($travel->kab_kota ?? '') }}">
                                    <div class="accordion-header" id="heading_{{ $accordionId }}">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse_{{ $accordionId }}" aria-expanded="false"
                                            aria-controls="collapse_{{ $accordionId }}">
                                            <div class="d-flex align-items-center justify-content-between w-100 me-3">
                                                <div class="d-flex align-items-center">
                                                    <i class="bx bx-building-house me-3 fs-4"></i>
                                                    <div>
                                                        <h6 class="mb-0 fw-bold text-truncate" style="max-width: 300px;"
                                                            title="{{ $travel->Penyelenggara ?? 'PPIU Tidak Diketahui' }}">
                                                            {{ $travel->Penyelenggara ?? 'PPIU Tidak Diketahui' }}
                                                        </h6>
                                                        <small
                                                            class="opacity-75">{{ $travel->kab_kota ?? 'Kabupaten Tidak Diketahui' }}</small>
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-center">
                                    ...
                                    <div id="collapse_{{ $accordionId }}" class="accordion-collapse collapse"
                                        aria-labelledby="heading_{{ $accordionId }}" data-bs-parent="#travelAccordion">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-6 text-end">
                                                        <button class="btn btn-sm btn-outline-primary me-2"
                                                            onclick="exportJamaah('{{ $travelId }}')">
                                                            <i class="bx bx-export me-1"></i>Export
                                                        </button>
                                                        <button class="btn btn-sm btn-outline-success"
                                                            onclick="printJamaah('{{ $accordionId }}')">
                                                ...
                                                <table class="table table-hover mb-0" id="table_{{ $accordionId }}">
                                                    ...
                                                    <tbody>
                                                        @foreach ($jamaahGroup as $key => $item)
                                                            <tr class="jamaah-row"
                                                                data-jamaah-name="{{ strtolower($item->nama) }}">
                                                                ...
                                                                <td>
                                                                    <span class="badge bg-light text-dark">
                                                                        <i
                                                                            class="bx bx-phone me-1"></i>{{ $item->nomor_hp }}
                                                                    </span>
                                                                </td>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <button class="btn btn-link btn-sm p-0 ms-2"
                                                                            ...
                                                                            <i id="icon_{{ $item->id }}"
                                                                                class="bx bxs-show text-primary"></i>
                                                                        </button>
                                                                    </div>
                                                                </td>
    ...
    <script>
        ...
        function globalSearch() {
            ...
            travelItems.forEach(item => {
                ...
                if (travelName.includes(searchTerm) || kabupaten.includes(searchTerm) || travelContent.includes(
                        searchTerm)) {
                    item.style.display = '';
                    currentVisibleCount++;
                } else {
        ...
        // confirmDelete(id, nama, entityLabel) provided globally by js/confirm-dialogs.js
