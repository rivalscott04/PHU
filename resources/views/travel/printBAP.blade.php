    ...
    <section class="sheet">
        <div class="letterhead">
            ...
            <div class="header">
                ...
                JL. Udayana No. 6 Mataram Telp. (0370) 622317 Faksimili (0370) 622317<br>
        ...
        <div class="content">
            ...
            <div class="form-group">
                <span class="label">Jumlah Jamaah</span>: <span class="input-line">{{ $data->people }}</span>
                Orang
            </div>
            <div class="form-group">
                <span class="label">Paket</span>: <span class="input-line">{{ $data->package }}</span>
                Hari
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <span class="label">Tanggal Berangkat</span>: <span class="input-line">{{ $data->datetime }}</span>
            </div>
            <div class="form-group">
                <span class="label">Nama Airline</span>: <span class="input-line">{{ $data->airlines }}</span>
            </div>
            <div class="form-group">
                <span class="label">Tanggal Kepulangan</span>: <span class="input-line">{{ $data->returndate }}</span>
            </div>
            <div class="form-group">
            ...
            <p style="font-size:10pt">Menerangkan bahwa kami memberangkatkan jamaah umroh sesuai dengan 5 PASTI
                UMROH
        ...
        <div class="footer">
            ...
            <div class="signature">
                Petugas PPIU<br>
                <span class="input-line" style="width:200px;display:inline-block"></span><br><br>
