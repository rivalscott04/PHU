...
<head>
    ...
    <style>
        ...
        .location { margin-bottom: 5px; font-weight: bold; }
        .title { margin-bottom: 20px; font-weight: bold; line-height: 1.3; text-align: left; }
...
<body>
    @php
        $signatory = \App\Models\SertifikatSetting::signatory();
        $jabatanText = rtrim($signatory->jabatan, ", \t\n\r");
    @endphp

    <div class="certificate">
        <div class="letterhead">
            <div class="letterhead-line">{{ \App\Support\KanwilContact::get('letterhead_ministry') }}</div>
            <div class="letterhead-line">{{ \App\Support\KanwilContact::get('letterhead_office') }}</div>
            <div class="letterhead-line">{{ \App\Support\KanwilContact::get('letterhead_province') }}</div>
            <div class="letterhead-contact">
                {{ \App\Support\KanwilContact::get('address') }} Telp. {{ \App\Support\KanwilContact::get('phone') }}
                · Email: {{ \App\Support\KanwilContact::get('email') }}
            </div>
        </div>
        ...
        <div class="signature">
            ...
            <div class="name">{{ $signatory->nama }}</div>
            <div class="nip">NIP. {{ $signatory->nip }}</div>
        </div>
    </div>
</body>
</html>
